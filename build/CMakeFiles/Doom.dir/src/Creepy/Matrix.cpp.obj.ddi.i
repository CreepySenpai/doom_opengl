# 0 "D:/WorkSpace/Game Project/C++ Games/Doom/src/Creepy/Matrix.cpp"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "D:/WorkSpace/Game Project/C++ Games/Doom/src/Creepy/Matrix.cpp"
...
# 2 "D:/WorkSpace/Game Project/C++ Games/Doom/src/Creepy/Matrix.cpp" 2
# 1 "D:/WorkSpace/Game Project/C++ Games/Doom/include/Creepy/Matrix.hpp" 1
       

# 1 "D:/WorkSpace/Game Project/C++ Games/Doom/include/Creepy/Vector.hpp" 1
       



# 4 "D:/WorkSpace/Game Project/C++ Games/Doom/include/Creepy/Vector.hpp"
union vec2 {
    struct{
        float x, y;
    };
...
# 4 "D:/WorkSpace/Game Project/C++ Games/Doom/include/Creepy/Matrix.hpp" 2
...
mat4 mat4_orthoProjection(float left, float right, float bottom, float top, float near, float far);

mat4 operator*(const mat4& lhs, const mat4& rhs);
# 3 "D:/WorkSpace/Game Project/C++ Games/Doom/src/Creepy/Matrix.cpp" 2
...
mat4 mat4_rotate(const vec3& axis, float angle) {
    ...
    const float tan = 1.0f - cos;

    const vec3 axisNormalized = vec3_normalize(axis);
    const float x = axisNormalized.x;
    const float y = axisNormalized.y;
    const float z = axisNormalized.z;

    mat4 res{0};
    res.a1 = tan * x * x * cos;
    res.a2 = tan * x * y - sin * z;
    res.a3 = tan * x * z + sin * y;
    res.a4 = 0.0f;
    res.b1 = tan * x * y + sin * z;
    res.b2 = tan * y * y + cos;
    res.b3 = tan * y * z - sin * x;
    res.b4 = 0.0f;
    res.c1 = tan * x * z - sin * y;
    res.c2 = tan * y * z + sin * x;
    res.c3 = tan * z * z + cos;
    res.c4 = 0.0f;
    res.d1 = 0.0f;
    res.d2 = 0.0f;
